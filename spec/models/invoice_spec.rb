...
RSpec.describe Invoice, type: :model do
  ...
  describe 'methods to be tested' do
    before(:each) do
    ...
    describe '.ordered_invoices_not_shipped' do
      it 'orders from oldest to newest a list of invoices that are not shipped' do
        ...
        expect(Invoice.ordered_invoices_not_shipped.second).to eq(@invoice_2)
        expect(Invoice.ordered_invoices_not_shipped.third).to eq(@invoice_5)
